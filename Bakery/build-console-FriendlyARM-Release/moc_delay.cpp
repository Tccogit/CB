...
#include "../MyFirstProject1.8/mylibs/delay.h"
...
static const char qt_meta_stringdata_Delay[] = {
    "Delay\0"
};
...
const QMetaObjectExtraData Delay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Delay::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Delay,
      qt_meta_data_Delay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Delay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Delay))
